[![CRAN version](http://www.r-pkg.org/badges/version/cpfa)](https://www.r-pkg.org/pkg/cpfa)
[![CRAN downloads](http://cranlogs.r-pkg.org/badges/grand-total/cpfa)](https://CRAN.R-project.org/package=cpfa)

# *cpfa*: Classification with Parallel Factor Analysis <img src="man/figures/logo.png" height="139" align="right" alt="cpfa logo"/>
