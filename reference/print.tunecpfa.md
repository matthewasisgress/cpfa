...
- x:
  ...
  A fit object of class 'tunecpfa' from function `tunecpfa`.
...
Prints names of the models and methods used to create the input
'tunecpfa' model object. Prints misclassification error rates and
